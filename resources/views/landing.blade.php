...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @php
        ...
        $lastLinkText = $hasSession ? "Dashboard" : "Login";
        $lastLinkRoute = $hasSession ? "/dashboard" : "/login"
    @endphp
    <body>
        <header class="bg-indigo-500">
            <nav class="container relative flex items-center justify-between px-6 py-8 mx-auto text-white">
                ...
                <div :class="[open ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']"
                    ...
                    <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-indigo-300"> About</a>
                    <a href="#" class="block text-white transition-colors duration-300 md:px-6 hover:text-indigo-300"> Portfolio</a>
                    <a href="/register" class="block text-white transition-colors duration-300 md:px-6 hover:text-indigo-300"> Register</a>
                    <a href="{{$lastLinkRoute}}" class="block text-white transition-colors duration-300 md:px-6 hover:text-indigo-300"> {{$lastLinkText}}</a>
                </div>
            </nav>
        </header>
